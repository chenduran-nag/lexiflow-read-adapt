...
import SpeechReader from '../speechReader/SpeechReader';
...
const TextReader = React.forwardRef<{ resetReader: () => void }>((_, ref) => {
            ...
            <>
              <Tabs defaultValue="read" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                  <TabsTrigger value="read">Text-to-Speech</TabsTrigger>
                ...
                <TabsContent value="speak">
                  <div className="p-4 border rounded-md bg-card">
                    <SpeechReader text={processedText} />
                  </div>
                </TabsContent>
              </Tabs>
            </>
